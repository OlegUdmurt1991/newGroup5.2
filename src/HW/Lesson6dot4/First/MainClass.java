...
public class MainClass {
    ...
    public static int[] applyFunction(Function function, int[] arr) {
    ...
    public static void main(String[] args) {
        ...
        Function wave = new Function() {
            ...
            public int evaluate(int a) {
                int result = a + zeroNum;
                zeroNum = a;
                return result;
            }
        };
        //Создание анонимного класса с лямбда-выражением
        Function squareEven = a -> {
            if (a%2==0) {
                return a*a;
            }
            return a;
        ...
        int[] result = applyFunction(operation, numbers);
